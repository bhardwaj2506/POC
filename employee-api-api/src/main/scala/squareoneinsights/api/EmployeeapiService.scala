...
/**
  * The employee-api service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the EmployeeapiService.
  */
trait EmployeeapiService extends Service {
  ...
  override final def descriptor: Descriptor = {
    ...
    named("employee-api")
      ...
      .withTopics(
        topic(EmployeeapiService.TOPIC_NAME, greetingsTopic _)
...
object Send {
  implicit val format: Format[Send] = Json.format[Send]
}*/
